...
################################################################################
## Form generated from reading UI file 'look_triples_view.ui'
##
...
class Ui_LookTriplesView(object):
    def setupUi(self, LookTriplesView):
        if not LookTriplesView.objectName():
            LookTriplesView.setObjectName(u"LookTriplesView")
        LookTriplesView.resize(800, 600)
        self.layoutWidget = QWidget(LookTriplesView)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 257, 497))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 257, 497))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 257, 497))
        ...
        self.retranslateUi(LookTriplesView)

        QMetaObject.connectSlotsByName(LookTriplesView)
    # setupUi

    def retranslateUi(self, LookTriplesView):
        LookTriplesView.setWindowTitle(QCoreApplication.translate("LookTriplesView", u"\u4e09\u5143\u7ec4\u67e5\u770b\u754c\u9762", None))
        self.file_delete3.setText(QCoreApplication.translate("LookTriplesView", u"\u5220\u9664\u6b64\u533a\u5757", None))
        self.file_choose2.setText(QCoreApplication.translate("LookTriplesView", u"\u9009\u62e9\u6587\u4ef6\u5939", None))
        self.file_delete2.setText(QCoreApplication.translate("LookTriplesView", u"\u5220\u9664\u6b64\u533a\u5757", None))
        self.file_choose3.setText(QCoreApplication.translate("LookTriplesView", u"\u9009\u62e9\u6587\u4ef6\u5939", None))
        self.add_button.setText(QCoreApplication.translate("LookTriplesView", u"\u6dfb\u52a0\u533a\u5757", None))
        self.file_choose1.setText(QCoreApplication.translate("LookTriplesView", u"\u9009\u62e9\u6587\u4ef6\u5939", None))
        self.file_delete1.setText(QCoreApplication.translate("LookTriplesView", u"\u5220\u9664\u6b64\u533a\u5757", None))
    # retranslateUi
